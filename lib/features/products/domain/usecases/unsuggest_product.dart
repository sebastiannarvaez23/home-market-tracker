...
class UnsuggestProduct extends UseCase<Product, String> {
  UnsuggestProduct(this._repository, {required Clock clock}) : _clock = clock;
  ...
  Future<Result<Product>> call(String params) async {
    ...
    if (!current.isActive) {
      return const Result.failure(
        Failure.inactive('No se puede quitar la sugerencia de un producto eliminado.'),
      );
    }
